...
abstract class AppTextStyle {
  ...
  static const stainbeckNormalText = TextStyle(
    fontSize: 18,
    fontWeight: FontWeight.normal,
    fontStyle: FontStyle.normal,
    fontFamily: AppFonts.steinbeck,
  ...
  static const stainbeckText = TextStyle(
    fontSize: 24,
    fontWeight: FontWeight.normal,
    fontStyle: FontStyle.normal,
    fontFamily: AppFonts.steinbeck,
  ...
  static const stainbeckHeadItalic = TextStyle(
    fontSize: 36,
    fontWeight: FontWeight.normal,
    fontStyle: FontStyle.italic,
    fontFamily: AppFonts.steinbeck,
  ...
  static const stainbeckHeadNormal = TextStyle(
    fontSize: 36,
    fontWeight: FontWeight.normal,
    fontStyle: FontStyle.normal,
    fontFamily: AppFonts.steinbeck,
